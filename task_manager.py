...
# functie view_tasks
# considerati ca aceste task-uri si citest dintr-un fisier JSON (se da acest fisier)

# aplicatia CLI: va avea un meniu care permite utilizatorului sa efectueze aceste operatii
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            t1.add_task(title, description, due_date, priority, status)
        elif choice == '2':
            try:
