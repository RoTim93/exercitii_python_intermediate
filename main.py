...
# abstractmethod -> decorator specific unei clase abstracte
# definitia unei functii si declararea sa?
# declaratia: semnatura functiei (def add(a, b) )
# definitia: def add(a,b): return a+b

class Figura(ABC):
    @abstractmethod  # decoratorul:  este o functie care "imbraca" alta functie. Functia care este "imbracata" extinde
    def area(self):  # functionalitatile unei componente pe care aplicam decoratorul.
        pass
